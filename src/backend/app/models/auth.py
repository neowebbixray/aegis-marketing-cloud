...
class User(BaseModel, TenantMixin):
    ...
    metadata_jsonb: Mapped[Optional[dict[str, Any]]] = mapped_column(JSONB, default=dict, nullable=True)
...
class ApiKey(BaseModel, TenantMixin):
    ...
    scopes: Mapped[Optional[dict[str, Any]]] = mapped_column(JSONB, default=list, nullable=True)
